					...
					<div style="height:500px;float:left;margin:10px 20px;width:96%;background-color:#fff; border-radius:3px; border:1px solid #f1f1f1">
						<div style="width:auto;color:#787878;padding:5px 20px;">
							...
							<div style="background-color:#fff;border-radius:3px;padding:10px;margin:20px 0px;">
								...
								<?php echo form_open('backend/menu/edit/'.$menu_id);?>
								<div style="width:90%;float:left;padding:0px 0px 50px 0px;">
									<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="hidden" name="kode" value="<?php echo $menu_id;?>"/>
									<div style="width:100%;float:left;">
										<label style="width:20%;float:left;text-align:left;margin-top:10px; margin-right:10px;">Name Label : </label>
										<input style="width:50%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;background-color:#e1e1e1;" type="text" name="name_old" value="<?php echo $menu_name;?>" readonly/>
									</div>
									<div style="width:100%;float:left;">
										<label style="width:20%;float:left;text-align:left;margin-top:10px; margin-right:10px;">Url : </label>
										<input style="width:50%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;background-color:#e1e1e1;" type="text" name="url_old" value="<?php echo $menu_url;?>" readonly/>
									</div>
									<div style="width:100%;float:left;">
									...
									<div style="width:100%">
										...
										<textarea style="height:75px;width:50%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="remark"><?php echo $menu_remark;?></textarea>
									</div>
									<div style="width:100%;float:left;">
