					...
					<div style="float:left;margin:10px 20px;width:96%;background-color:#fff; border-radius:3px; border:1px solid #f1f1f1">
						<div style="width:auto;color:#787878;padding:5px 20px;">
							...
							<div style="background-color:#fff;border-radius:3px;padding:10px;margin:20px 0px;">
								...
								<?php echo form_open_multipart('backend/manage_page/add/');?>
								<div style="width:80%;float:left;padding:30px 0px 50px 0px;">
										...
										<div style="width:100%">
											...
											<textarea style="width:90%;height:50px;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" name="short">
											</textarea>
										</div>
										<div style="width:100%">
											<label style="width:90%;float:left;text-align:left;margin-top:10px; margin-right:10px;">Image Page*</label>
										...
										<div style="width:100%;float:left">
											...
											<select style="width:90%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="category">
												...
												if($category->num_rows == 0){
													echo "<option value='' selected disabled> --Select Category Page--</option>";
												}else{
													echo "<option value='' selected disabled> --Select Category Page--</option>";
													foreach($category->result() as $db){
														echo "<option value='".$db->page_category_id."'>".$db->page_category_name."</option>";
													}	
												}
												?>
											</select>
