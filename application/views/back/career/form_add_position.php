						...
						<div style="width:auto;color:#787878;padding:5px 20px;">
							...
							<div style="background-color:#fff;border-radius:3px;padding:10px;margin:20px 0px;">
								<div>
									...
									<?php echo form_open('backend/manage_career/add_position/');?>
								</div>
								<div style="width:1000px;float:left;padding:20px 0px;">
										...
										<div style="width:100%;float:left;">
											...
											<input style="width:20%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="short"/>
										</div>
										<div style="width:100%;float:left;">
										...
										<div style="width:100%;float:left;">
											...
											<textarea style="width:60%;height:150px;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="desc"></textarea>
										</div>
										<div style="width:100%;float:left;">
