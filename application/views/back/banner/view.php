				...
				<div style="float:left;width:100%;height:11.5%;background:#fff;color:#787878;">
					<div style="margin:0px 20px;width:auto;">	
						<h2 style="text-transform:uppercase;"><i class="fa fa-photo" style="margin-right:10px"></i>Banner Settings</h2>
					</div>
				</div>
				<!-- End of header -->
				<!-- Separator -->
							...
							<div style="width:auto;color:#787878;padding:5px 20px;">
								...
								<div style="margin-bottom:20px">
									...
									<div style="float:left;margin:10px 0px;">
										<a href="<?php echo base_url();?>index.php/backend/banner/add/"><button style="font-size:14px;padding:5px 10px;border:1px solid #ccc;list-style:none;color:#717171;margin:0px 2px;background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#f8f8f8), to(#e9e9e9));
    background: -moz-linear-gradient(0% 0% 270deg,#f8f8f8, #e9e9e9);border-radius:3px;box-shadow: inset 0px 1px 0px rgba(255,255,255, .8), 0px 1px 3px rgba(0,0,0, .1);"><i class="fa fa-plus" style="margin-right:5px;"></i>Add New</button></a>
									...
									<div style="float:left;margin:10px 0px;">
										<a href="<?php echo base_url();?>index.php/backend/banner"><button style="font-size:14px;padding:5px 10px;border:1px solid #ccc;list-style:none;color:#717171;margin:0px 2px;background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#f8f8f8), to(#e9e9e9));
    background: -moz-linear-gradient(0% 0% 270deg,#f8f8f8, #e9e9e9);border-radius:3px;box-shadow: inset 0px 1px 0px rgba(255,255,255, .8), 0px 1px 3px rgba(0,0,0, .1);"><i class="fa fa-refresh" style="margin-right:5px;"></i>Refresh</button></a>
									...
									<?php echo form_open('backend/banner/search/');?>
    ...
    background: -moz-linear-gradient(0% 0% 270deg,#f8f8f8, #e9e9e9);border-radius:3px;box-shadow: inset 0px 1px 0px rgba(255,255,255, .8), 0px 1px 3px rgba(0,0,0, .1);">
											<td style="border-bottom:1px solid #ccc;padding:10px;font-weight:bold">Banner Title</td>
									...
									<tbody>
										<?php if($banner_grid->num_rows() == 0){?>
											<tr>
												<td colspan="3">Data Banner is Empty</td>
											</tr>
										<?php }else{ 
												foreach($banner_grid->result() as $db){
													echo "<tr>";
													echo "<td style='border-bottom:1px solid #ccc;padding:10px;'>
														<div style='width:200px'>
																<div style='float:left;width:100%'>
																	<span style='width:100%;float:left'>".$db->banner_title."</span>
																	<span style='width:100%;float:left'><a style='margin-right:15px;font-size:12px;text-decoration:none;color:#666;' href='".base_url()."index.php/backend/banner/content_add/".$db->banner_id."'><i class='fa fa-star' style='margin-right:5px;'></i>Content</a><a style='margin-right:15px;font-size:12px;text-decoration:none;color:#666;' href='".base_url()."index.php/backend/banner/form_edit/".$db->banner_id."'><i class='fa fa-edit' style='margin-right:5px;'></i>Edit</a> <a style='margin-right:15px;font-size:12px;text-decoration:none;color:#666;' href='".base_url()."index.php/backend/banner/delete/".$db->banner_id."'><i class='fa fa-trash-o' style='margin-right:5px;'></i>Delete</a></span>
																</div>
														</div>
														</td>";
													echo "<td style='border-bottom:1px solid #ccc;padding:10px;'>".$db->banner_url."</td>";
													echo "</td>";
													echo "<td style='border-bottom:1px solid #ccc;padding:10px;'>";
													echo "<span style='font-size:14px;'><i class='fa fa-clock-o'>".$db->banner_date_modify."</i><br>Create Date</span>";
													echo "</td>";
													echo "</tr>";
