						...
						<div style="width:auto;color:#787878;padding:5px 20px;">
							...
							<div style="background-color:#fff;border-radius:3px;padding:10px;margin:20px 0px;">
								<div>
									...
									<?php echo form_open('backend/manage_tag/add/');?>
								</div>
								<div style="width:400px;">
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Tag Name*</label>
										...
										<div style="width:100%">
											...
											<textarea style="width:60%;height:300px;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="desc"></textarea>
										</div>
										<div style="width:100%;">
    ...
    background: -moz-linear-gradient(0% 0% 270deg,#f8f8f8, #e9e9e9);border-radius:3px;box-shadow: inset 0px 1px 0px rgba(255,255,255, .8), 0px 1px 3px rgba(0,0,0, .1);padding:5px;" type="submit"><i class="fa fa-send" style="margin-right:5px;"></i>Submit</button>
												<a href="<?php echo base_url(); ?>index.php/backend/manage_tag/" style="text-decoration:none;cursor:pointer;font-size:14px;border:1px solid #ccc;list-style:none;color:#717171;margin:0px 2px;background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#f8f8f8), to(#e9e9e9));
