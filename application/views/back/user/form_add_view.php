						...
						<div style="width:auto;color:#787878;padding:5px 20px;">
							...
							<div style="background-color:#fff;border-radius:3px;padding:10px;margin:20px 0px;">
								<div>
									...
									<?php echo form_open('backend/manage_user/add/'); ?>
								</div>
								<div style="width:400px;">
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">First Name*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="first"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Last Name</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="last"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Nick Name*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="nick"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Username*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="username"/>
										</div>	
										<div style="width:100%">	
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Password*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="password" name="password"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Confirm*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="password" name="confirm"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Email*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="email"/>
										</div>
										<div style="width:100%;">
