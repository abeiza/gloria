						...
						<div style="width:auto;color:#787878;padding:5px 20px;">
							...
							<div style="background-color:#fff;border-radius:3px;padding:10px;margin:20px 0px;">
								<div>
									...
									<?php echo form_open('backend/manage_user/edit/'.$id); ?>
								</div>
								<div style="width:400px;">
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">First Name*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="first" value="<?php echo $first;?>"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Last Name</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="last" value="<?php echo $last;?>"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Nick Name*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="nick" value="<?php echo $nick;?>"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Username*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="text" name="username" value="<?php echo $username;?>"/>
										</div>	
										<div style="width:100%">	
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Password*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="password" name="password" value="<?php echo $password;?>"/>
										</div>
										<div style="width:100%">
											<label style="width:30%;float:left;text-align:right;margin-top:10px; margin-right:10px;">Confirm*</label>
											<input style="width:60%;float:left;margin:5px 0px;padding:7px;border:1px solid #ccc;" type="password" name="confirm" value=""/>
										</div>
										<div style="width:100%">
    ...
    background: -moz-linear-gradient(0% 0% 270deg,#f8f8f8, #e9e9e9);border-radius:3px;box-shadow: inset 0px 1px 0px rgba(255,255,255, .8), 0px 1px 3px rgba(0,0,0, .1);padding:5px;" type="submit"><i class="fa fa-send" style="margin-right:5px;"></i>Submit</button>
												<a href="<?php echo base_url(); ?>index.php/backend/manage_user/" style="text-decoration:none;cursor:pointer;font-size:14px;border:1px solid #ccc;list-style:none;color:#717171;margin:0px 2px;background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#f8f8f8), to(#e9e9e9));
