        ...
        <div id="tagLineShadow" class="sixteen columns"></div>
			...
			<script>
				...
				function validationEmail(){
					var email = document.getElementById("pribadi_email").value;
					if(validateEmail(email)){
						
					}else{
						alert("Mohon isikan alamat email anda degan benar");
						document.getElementById("pribadi_email").focus();
					}
					return false;
				}

				function validationRequired(){
					var d1 = document.getElementById("pribadi_nama_lengkap");
					var d2 = document.getElementById("pribadi_nama_panggilan");
					var d3 = document.getElementById("pribadi_jk");
					var d4 = document.getElementById("pribadi_alamat");
					var d5 = document.getElementById("hp");
					var d6 = document.getElementById("pribadi_email");
					var d7 = document.getElementById("pribadi_tempat");
					var d8 = document.getElementById("pribadi_tgl_lahir");
					var d9 = document.getElementById("pribadi_pendidikan");
					var d10 = document.getElementById("pribadi_tgl_lulus");
					var d11 = document.getElementById("pribadi_agama");
					var d12 = document.getElementById("pribadi_suku");
					var d13 = document.getElementById("pribadi_status");
					var d14 = document.getElementById("pribadi_warganegara");
					var d15 = document.getElementById("pribadi_berat");
					var d16 = document.getElementById("pribadi_tinggi");
					var d17 = document.getElementById("pribadi_type_iden");
					var d18 = document.getElementById("pribadi_no_iden");
					var d19 = document.getElementById("pict");
					
					if(d1.value == '' || d2.value == '' || d3.value == '' || d4.value == '' || d5.value == '' || d6.value == '' || d7.value == '' || d8.value == '' || d9.value == '' || d10.value == '' || d11.value == '' || d12.value == '' || d13.value == '' || d14.value == '' || d15.value == '' || d16.value == '' || d17.value == '' || d18.value == '' || d19.value == '')
					{
						alert("Maaf Data yang Anda Isikan Belum Lengkap \nMohon Untuk Segera Dilengkapi");
						if(d1.value == ''){
							d1.style.borderColor = "#D84417";
						}else{
							d1.style.borderColor = "#ccc";
						}
						
						if(d2.value == ''){
							d2.style.borderColor = "#D84417";
						}else{
							d2.style.borderColor = "#ccc";
						}
						
						if(d3.value == ''){
							d3.style.borderColor = "#D84417";
						}else{
							d3.style.borderColor = "#ccc";
						}
						
						if(d4.value == ''){
							d4.style.borderColor = "#D84417";
						}else{
							d4.style.borderColor = "#ccc";
						}
						
						if(d5.value == ''){
							d5.style.borderColor = "#D84417";
						}else{
							d5.style.borderColor = "#ccc";
						}
						
						if(d6.value == ''){
							d6.style.borderColor = "#D84417";
						}else{
							d6.style.borderColor = "#ccc";
						}
						
						if(d7.value == ''){
							d7.style.borderColor = "#D84417";
						}else{
							d7.style.borderColor = "#ccc";
						}
						
						if(d8.value == ''){
							d8.style.borderColor = "#D84417";
						}else{
							d8.style.borderColor = "#ccc";
						}
						
						if(d9.value == ''){
							d9.style.borderColor = "#D84417";
						}else{
							d9.style.borderColor = "#ccc";
						}
						
						if(d10.value == ''){
							d10.style.borderColor = "#D84417";
						}else{
							d10.style.borderColor = "#ccc";
						}
						
						if(d11.value == ''){
							d11.style.borderColor = "#D84417";
						}else{
							d11.style.borderColor = "#ccc";
						}
						
						if(d12.value == ''){
							d12.style.borderColor = "#D84417";
						}else{
							d12.style.borderColor = "#ccc";
						}
						
						if(d13.value == ''){
							d13.style.borderColor = "#D84417";
						}else{
							d13.style.borderColor = "#ccc";
						}
						
						if(d14.value == ''){
							d14.style.borderColor = "#D84417";
						}else{
							d14.style.borderColor = "#ccc";
						}
						
						if(d15.value == ''){
							d15.style.borderColor = "#D84417";
						}else{
							d15.style.borderColor = "#ccc";
						}
						
						if(d16.value == ''){
							d16.style.borderColor = "#D84417";
						}else{
							d16.style.borderColor = "#ccc";
						}
						
						if(d17.value == ''){
							d17.style.borderColor = "#D84417";
						}else{
							d17.style.borderColor = "#ccc";
						}
						
						if(d18.value == ''){
							d18.style.borderColor = "#D84417";
						}else{
							d18.style.borderColor = "#ccc";
						}
						
						if(d19.value == ''){
							d19.style.background = "#D84417";
						}else{
							d19.style.background = "#fff";
						}
					}else{
						d1.style.borderColor = "#ccc";
						d2.style.borderColor = "#ccc";
						...
						mylinkfunction('fmy_fil','family');
					}
					return false;
				}
				
				function validationAgreement(data1, data2){
					var agree = document.getElementById( data1 );
					if(agree.checked == true){
						...
						document.getElementById( data2 ).style.opacity = 0.7;
					}
					return false;
				}
				
				function formStatus(){
					var status = document.getElementById('pribadi_status').value;
					if(status == 'menikah'){
						document.getElementById('kolom_keluarga').style.display = 'table';
						document.getElementById('kolom_anak').style.display = 'table';
					}else if(status == 'cerai'){
						document.getElementById('kolom_anak').style.display = 'table';
						document.getElementById('kolom_keluarga').style.display = 'none';
					}else if(status == 'lajang'){
						document.getElementById('kolom_keluarga').style.display = 'none';
						document.getElementById('kolom_anak').style.display = 'none';
					}
					return false;
				}
				
				function formLamarLain(){
					var apply = document.getElementById('pekerjaan_pertanyaan_satu');
					if(apply.checked == true){
						document.getElementById('form_perusahaan_lain').style.display = 'block';
					}else if(apply.checked == false){
						document.getElementById('form_perusahaan_lain').style.display = 'none';
					}
					return false;
				}
			...
			<div class="row">
				<div style="margin:2%;width:98%;float:left;">
					<ul style="float:left;width:100%;" class="tab">
						...
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="prs_fil">
						...
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="fmy_fil">
						...
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="edu_fil">
				...
				<div style="margin:20px;float:left;" id="personal" class="tabcontent">
					...
					<div style="float:left;width:20%;">
						...
						<input type="file" style="margin-top:10px;float:left" name="pict" id="pict" value="<?php echo set_value('pict')?>"/>
						<div style="font-size:11px;color:#D84417">
							<span style="width:100%;padding:1px 0px;float:left;margin:0px;">Max. File : 250Kb<br/>Size Recommend File : 400 x 600<br/>Format File : JPG | JPEG | PNG</span>
					...
					<div style="float:left;width:80%;">
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i> 
							<input type="text" name="pribadi_nama_lengkap" id="pribadi_nama_lengkap" class="input-text" style="width:60%;"  value="<?php echo set_value('pribadi_nama_lengkap')?>"/>
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" name="pribadi_nama_panggilan" id="pribadi_nama_panggilan" class="input-text" value="<?php echo set_value('pribadi_nama_panggilan')?>"/>
						...
						<div class="group-text" style="padding-bottom:20px">
							...
							<div style="width:60%;float:left;">
								<input type="radio" name="pribadi_jk" id="pribadi_jk" value="L" <?php echo set_radio('pribadi_jk','L');?> checked/>Laki-laki
								<input type="radio" name="pribadi_jk" id="pribadi_jk" value="P" <?php echo set_radio('pribadi_jk','P');?>/>Perempuan
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<textarea name="pribadi_alamat" id="pribadi_alamat" class="input-text"><?php echo set_value('pribadi_alamat');?></textarea>
						...
						<div class="group-text">
							...
							<input type="text" name="pribadi_telp" id="pribadi_telp" onkeypress="return validationNumber(event);" class="input-radio" style="width:22%;" value="<?php echo set_value('pribadi_telp');?>"/>
							<label for="pribadi_hp" class="label-text" style="margin-left:2%;width:13%;margin-right:0px;text-align:left;">Hp</label>
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i> 
							<input type="text" name="pribadi_hp" id="hp" class="input-radio"  onkeypress="return validationNumber(event);" style="width:22%;" value="<?php echo set_value('pribadi_hp');?>"/>
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" onblur="validationEmail();" name="pribadi_email" id="pribadi_email" class="input-text" value="<?php echo set_value('pribadi_email');?>"/>
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" style="width:15%;float:left;" name="pribadi_tempat" id="pribadi_tempat" value="<?php echo set_value("pribadi_tempat");?>"/> 
							...
							" maxlength='10' style="width:19%;float:left;" name="pribadi_tgl_lahir" placeholder="dd/mm/yyyy" id="pribadi_tgl_lahir" value="<?php echo set_value('pribadi_tgl_lahir');?>"/>
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<select name="pribadi_pendidikan" id="pribadi_pendidikan" class="input-radio" style="width:23.3%;">
							...
							<input type="text" onkeypress="
								...
								return validationNumber(event);
							" maxlength='10' name="pribadi_tgl_lulus" id="pribadi_tgl_lulus" placeholder="dd/mm/yyyy" class="input-radio" style="width:22%;" value="<?php echo set_value("pribadi_tgl_lulus");?>"/>
						</div>
						
						<div class="group-text">
							<label for="pribadi_agama" class="label-text">Agama</label>
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<select name="pribadi_agama" id="pribadi_agama" class="input-radio" style="width:23.3%;">
								<option value="" disabled selected> -- Pilih Agama -- </option>
								<option value="Budha" <?php echo set_select('pribadi_agama','Budha'); ?>>Budha</option>
								<option value="Hindu" <?php echo set_select('pribadi_agama','Hindu'); ?>>Hindu</option>
								<option value="Islam" <?php echo set_select('pribadi_agama','Islam'); ?>>Islam</option>
								<option value="Katolik" <?php echo set_select('pribadi_agama','Katolik'); ?>>Katolik</option>
								<option value="Protestan" <?php echo set_select('pribadi_agama','Protestan'); ?>>Kristen Protestan</option>
							</select>
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" name="pribadi_suku" id="pribadi_suku" class="input-radio" style="width:22%;" value="<?php echo set_value('pribadi_suku');?>"/>
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<select name="pribadi_status" id="pribadi_status" class="input-radio" style="width:23.3%;" onBlur="formStatus();">
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" name="pribadi_warganegara" id="pribadi_warganegara" class="input-radio" style="width:22%;" value="<?php echo set_value('pribadi_warganegara');?>"/>
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" name="pribadi_berat" id="pribadi_berat" class="input-radio"  onkeypress="return validationNumber(event);" style="width:22%;" value="<?php echo set_value('pribadi_berat');?>"/>
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" name="pribadi_tinggi" id="pribadi_tinggi" class="input-radio"  onkeypress="return validationNumber(event);" style="width:22%;" value="<?php echo set_value('pribadi_tinggi');?>"/>
						...
						<div class="group-text">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<select name="pribadi_type_iden" id="pribadi_type_iden" class="input-radio" style="width:23.3%;">
							...
							<i class="fa fa-asterisk" style="font-size:6px;float:left;margin-left:-15px;color:red;"></i>
							<input type="text" name="pribadi_no_iden" id="pribadi_no_iden" class="input-radio" style="width:22%;" vaue="<?php echo set_value('pribadi_no_iden');?>"/>
						...
						<a href="#" class="tablinks" onclick="validationRequired()" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;">Next<i class="fa fa-angle-right" style="margin-left:10px;"></i></a>
					</div>
				</div>
				<div style="margin:20px;float:left;" id="family" class="tabcontent">
					...
					<div style="float:left;width:100%;">
						...
						<div class="group-text">
							...
							<input type="text"  onkeypress="return validationNumber(event);"  name="keluarga_anak_ke" class="input-radio" style="width:5%;outline:none;" value="<?php echo set_value('keluarga_anak_ke');?>"/>
							<label for="keluarga_dari_brp" class="label-text" style="margin-left:2%;width:3%;margin-right:0px;text-align:left;">dari </label>
							<input type="text"  onkeypress="return validationNumber(event);"  name="keluarga_dari_brp" class="input-radio" style="width:5%;outline:none;" value="<?php echo set_value('keluarga_dari_brp');?>"/>
						...
						<table>
							...
							<tbody>
								<tr>
										...
										<td><input type='text'  onkeypress="return validationNumber(event);" style="outline:none;margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="keluarga_ayah_usia" value="<?php echo set_value('keluarga_ayah_usia');?>"/></td>
										<td>
								...
								<tr>
										...
										<td><input type='text' onkeypress="return validationNumber(event);" style="outline:none;margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="keluarga_ibu_usia" value="<?php echo set_value('keluarga_ibu_usia');?>"/></td>
										<td>
						...
						<div class="group-text">
							...
							<input type="text" onkeypress="return validationNumber(event);" name="keluarga_telp_ortu" class="input-radio" style="width:22%;" value="<?php echo set_value('keluarga_telp_ortu');?>"/>
						</div>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_saudara_satu_usia" value="<?php echo set_value('keluarga_saudara_satu_usia');?>"/></td>
									<td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_saudara_dua_usia" value="<?php echo set_value('keluarga_saudara_dua_usia');?>"/></td>
									<td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_saudara_tiga_usia" value="<?php echo set_value('keluarga_saudara_tiga_usia');?>"/></td>
									<td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_saudara_empat_usia" value="<?php echo set_value('keluarga_saudara_empat_usia');?>"/></td>
									<td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_saudara_lima_usia" value="<?php echo set_value('keluarga_saudara_lima_usia');?>"/></td>
									<td>
						...
						<table id="kolom_keluarga" style="display:none;">
							<thead>
								<tr>
									<td>Suami Istri</td>
									<td>Nama Lengkap</td>
							...
							<tbody>
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="outline:none;margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="keluarga_pasangan_usia" value="<?php echo set_value('keluarga_pasangan_usia');?>"/></td>
									<td>
						...
						<table id="kolom_anak" style="display:none;">
							<thead>
								<tr>
									<td>Anak</td>
									<td>Nama Lengkap</td>
							...
							<tbody>
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_anak_satu_usia" value="<?php echo set_value('keluarga_anak_satu_usia');?>"/></td>
									<td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_anak_dua_usia" value="<?php echo set_value('keluarga_anak_dua_usia');?>"/></td>
									<td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" name="keluarga_anak_tiga_usia" value="<?php echo set_value('keluarga_anak_tiga_usia');?>"/></td>
									<td>
				...
				<div style="margin:20px;float:left;" id="education" class="tabcontent">
					...
					<div style="float:left;width:100%;">
						<table>
							...
							<tbody>
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_masuk_sd" value="<?php echo set_value('pendidikan_tahun_masuk_sd');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_keluar_sd" value="<?php echo set_value('pendidikan_tahun_keluar_sd');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_masuk_smp" value="<?php echo set_value('pendidikan_tahun_masuk_smp');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_keluar_smp" value="<?php echo set_value('pendidikan_tahun_keluar_smp');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_masuk_smu" value="<?php echo set_value('pendidikan_tahun_masuk_smu');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_keluar_smu" value="<?php echo set_value('pendidikan_tahun_keluar_smu');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_masuk_univ" value="<?php echo set_value('pendidikan_tahun_masuk_univ');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_keluar_univ" value="<?php echo set_value('pendidikan_tahun_keluar_univ');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_masuk_pasca" value="<?php echo set_value('pendidikan_tahun_masuk_pasca');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center;" name="pendidikan_tahun_keluar_pasca" value="<?php echo set_value('pendidikan_tahun_keluar_pasca');?>"/></td>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="pendidikan_ekstra_satu_tahun" value="<?php echo set_value('pendidikan_ekstra_satu_tahun');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="pendidikan_ekstra_dua_tahun" value="<?php echo set_value('pendidikan_ekstra_dua_tahun');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="pendidikan_ekstra_tiga_tahun" value="<?php echo set_value('pendidikan_ekstra_tiga_tahun');?>"/></td>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="pendidikan_aktivitas_satu_tahun" value="<?php echo set_value('pendidikan_aktivitas_satu_tahun');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="pendidikan_aktivitas_dua_tahun" value="<?php echo set_value('pendidikan_aktivitas_dua_tahun');?>"/></td>
								...
								<tr>
									...
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;text-align:center" name="pendidikan_aktivitas_tiga_tahun" value="<?php echo set_value('pendidikan_aktivitas_tiga_tahun');?>"/></td>
						...
						<div class="group-text">	
							...
							<input type="text" name="pendidikan_prestasi_satu_tahun" onkeypress="return validationNumber(event);" class="input-radio" style="width:22%;" value="<?php echo set_value('pendidikan_prestasi_satu_tahun');?>"/>
							...
							<input type="text" name="pendidikan_prestasi_dua_tahun" onkeypress="return validationNumber(event);" class="input-radio" style="width:22%;" value="<?php echo set_value('pendidikan_prestasi_dua_tahun');?>"/>
							...
							<input type="text" name="pendidikan_prestasi_tiga_tahun" onkeypress="return validationNumber(event);" class="input-radio" style="width:22%;" value="<?php echo set_value('pendidikan_prestasi_tiga_tahun');?>"/>
						</div>
						...
						<div class="group-text">	
							...
							<div style="width:100%;float:left;">
								...
								<input type="text" name="pendidikan_tahun_karya" onkeypress="return validationNumber(event);" class="input-radio" style="width:50%;" value="<?php echo set_value('pendidikan_tahun_karya');?>"/>
							</div>
							<div style="width:100%;float:left;">
				...
				<div style="margin:20px;float:left;" id="experience" class="tabcontent">
					...
					<h4>#Step 4</h4>
					<hr/>
					<span>Mulai dari yang terakhir / tempat sekarang bekerja.</span>
					<div style="float:left;width:100%;">
						<table class="table-career">
							...
							<tbody>
								<tr>
									...
									<td><input type='text' style="margin:0;background:transparent;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_lama" value="<?php echo set_value('pekerjaan_perusahaan_satu_lama');?>"/></td>
									<td><input type='text' style="margin:0;background:transparent;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_lama" value="<?php echo set_value('pekerjaan_perusahaan_dua_lama');?>"/></td>
									<td><input type='text' style="margin:0;background:transparent;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_lama" value="<?php echo set_value('pekerjaan_perusahaan_tiga_lama');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Nama Perusahaan</td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_nama" value="<?php echo set_value('pekerjaan_perusahaan_satu_nama');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_nama" value="<?php echo set_value('pekerjaan_perusahaan_dua_nama');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_nama" value="<?php echo set_value('pekerjaan_perusahaan_tiga_nama');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Alamat & Telp</td>
									<td><textarea type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_alamat_telp"><?php echo set_value('pekerjaan_perusahaan_satu_alamat_telp');?></textarea></td>
									<td><textarea type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_alamat_telp"><?php echo set_value('pekerjaan_perusahaan_dua_alamat_telp');?></textarea></td>
									<td><textarea type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_alamat_telp"><?php echo set_value('pekerjaan_perusahaan_tiga_alamat_telp');?></textarea></td>
								</tr>
								<tr>
									<td style="text-align:left;">Bergerak di Bidang</td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_bidang" value="<?php echo set_value('pekerjaan_perusahaan_satu_bidang');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_bidang" value="<?php echo set_value('pekerjaan_perusahaan_dua_bidang');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_bidang" value="<?php echo set_value('pekerjaan_perusahaan_tiga_bidang');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Jabatan Terakhir</td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_jabatan" value="<?php echo set_value('pekerjaan_perusahaan_satu_jabatan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_jabatan" value="<?php echo set_value('pekerjaan_perusahaan_dua_jabatan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_jabatan" value="<?php echo set_value('pekerjaan_perusahaan_tiga_jabatan');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Nama Atasan Langsung</td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_nama_atasan" value="<?php echo set_value('pekerjaan_perusahaan_satu_nama_atasan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_nama_atasan" value="<?php echo set_value('pekerjaan_perusahaan_dua_nama_atasan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_nama_atasan" value="<?php echo set_value('pekerjaan_perusahaan_tiga_nama_atasan');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Gaji Pokok</td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_gapok" value="<?php echo set_value('pekerjaan_perusahaan_satu_gapok');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_gapok" value="<?php echo set_value('pekerjaan_perusahaan_dua_gapok');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_gapok" value="<?php echo set_value('pekerjaan_perusahaan_tiga_gapok');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Tunjangan</td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_tunjangan" value="<?php echo set_value('pekerjaan_perusahaan_satu_tunjangan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_tunjangan" value="<?php echo set_value('pekerjaan_perusahaan_dua_tunjangan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_tunjangan" value="<?php echo set_value('pekerjaan_perusahaan_tiga_tunjangan');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Fasilitas</td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_fasilitas" value="<?php echo set_value('pekerjaan_perusahaan_satu_fasilitas');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_fasilitas" value="<?php echo set_value('pekerjaan_perusahaan_dua_fasilitas');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_fasilitas" value="<?php echo set_value('pekerjaan_perusahaan_tiga_fasilitas');?>"/></td>
								</tr>
								<tr>
									<td style="text-align:left;">Uraikan Tugas & Tanggung Jawab Saudara pada Jabata Terakhir</td>
									<td><textarea style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_tugas"><?php echo set_value('pekerjaan_perusahaan_satu_tugas');?></textarea></td>
									<td><textarea style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_tugas"><?php echo set_value('pekerjaan_perusahaan_dua_tugas');?></textarea></td>
									<td><textarea style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_tugas"><?php echo set_value('pekerjaan_perusahaan_tiga_tugas');?></textarea></td>
								</tr>
								<tr>
									<td style="text-align:left;">Alasan Keluar</td>
									<td><textarea style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_satu_alasan"><?php echo set_value('pekerjaan_perusahaan_satu_alasan');?></textarea></td>
									<td><textarea style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_dua_alasan"><?php echo set_value('pekerjaan_perusahaan_dua_alasan');?></textarea></td>
									<td><textarea style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_perusahaan_tiga_alasan"><?php echo set_value('pekerjaan_perusahaan_tiga_alasan');?></textarea></td>
								</tr>
							</tbody>
						</table>
						
						<span>Apakah saat ini Saudara melamar pula di perusahaan lain?</span>
						<input name="pekerjaan_pertanyaan_satu" id="pekerjaan_pertanyaan_satu" onClick="formLamarLain();" <?php echo set_radio('pekerjaan_pertanyaan_satu','1');?> type="radio" value='1'/>Ya / 
						<input name="pekerjaan_pertanyaan_satu" id="pekerjaan_pertanyaan_satu" onClick="formLamarLain();" <?php echo set_radio('pekerjaan_pertanyaan_satu','0');?> type="radio" value="0"/>Tidak
						<span>Jika Ya, Perusahaan apa</span>
						<div class="group-text" id="form_perusahaan_lain" style="display:none;">	
							<div class="group-text">
							<label for="pekerjaan_perusahaan_lain_nama" class="label-text">Nama Perusahaan</label>
							<input type="text" name="pekerjaan_perusahaan_lain_nama" class="input-text" style="width:60%;" value="<?php echo set_value('pekerjaan_perusahaan_lain_nama');?>"/>
							<div class="group-text">
							<label for="pekerjaan_lain_sebagai" class="label-text">Sebagai</label>
							<input type="text" name="pekerjaan_lain_sebagai" class="input-text" style="width:60%;" value="<?php echo set_value('pekerjaan_lain_sebagai');?>"/>
						</div>
						<div class="group-text">
							<label for="pekerjaan_lain_kapan" class="label-text">Kapan</label>
							<input type="text" name="pekerjaan_lain_kapan" class="input-text" style="width:60%;" value="<?php echo set_value('pekerjaan_lain_kapan');?>"/>
						</div>
						</div>
						</div>
						...
						<table>
							...
							<tbody>
								<tr>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_satu_nama" value="<?php echo set_value('pekerjaan_referensi_satu_nama');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_satu_jabatan" value="<?php echo set_value('pekerjaan_referensi_satu_jabatan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_satu_alamat" value="<?php echo set_value('pekerjaan_referensi_satu_alamat');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" value="<?php echo set_value('pekerjaan_referensi_satu_telp');?>" name="pekerjaan_referensi_satu_telp"/></td>
								</tr>
								<tr>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_dua_nama" value="<?php echo set_value('pekerjaan_referensi_dua_nama');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_dua_jabatan" value="<?php echo set_value('pekerjaan_referensi_dua_nama');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_dua_alamat"  value="<?php echo set_value('pekerjaan_referensi_dua_nama');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;"  value="<?php echo set_value('pekerjaan_referensi_dua_nama');?>" name="pekerjaan_referensi_dua_telp"/></td>
								</tr>
								<tr>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_tiga_nama" value="<?php echo set_value('pekerjaan_referensi_tiga_nama');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_tiga_jabatan" value="<?php echo set_value('pekerjaan_referensi_tiga_jabatan');?>"/></td>
									<td><input type='text' style="margin:0;width:100%;padding:0;height:100%;border:none;" name="pekerjaan_referensi_tiga_alamat" value="<?php echo set_value('pekerjaan_referensi_tiga_alamat');?>"/></td>
									<td><input type='text' onkeypress="return validationNumber(event);" style="margin:0;width:100%;padding:0;height:100%;border:none;" value="<?php echo set_value('pekerjaan_referensi_tiga_telp');?>" name="pekerjaan_referensi_tiga_telp"/></td>
								</tr>
							</tbody>
						</table>
				...
				<div style="margin:20px;float:left;" id="other" class="tabcontent">
					...
					<div style="float:left;width:100%;">
						...
						<div class="group-text">	
							<input name="other_pertanyaan_a" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_a');?>"/>
						</div>	
						<p>Bagaimana cara saudara mengisi waktu luang?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_b" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_b');?>"/>
						</div>
						<p>Majalah / Surat Kabar apa yang dibaca?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_c" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_c');?>"/>
						</div>
						
						<p>Masalah / Topik yang diminati?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_d" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_d');?>"/>
						</div>
						
						<p>Pernahkah saudara sakit keras? Jika ya, sertakan nama penyakitnya dan pada tahun berapa.</p>
						<div class="group-text">	
							<input name="other_pertanyaan_e" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_e');?>"/>
						</div>
						
						<p>Pernahkah saudara dioperasi/dirawat di RS? Jika ya, sertakan nama penyakitnya dan pada tahun berapa.</p>
						<div class="group-text">	
							<input name="other_pertanyaan_f" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_f');?>"/>
						</div>
						
						<p>Pernahkan saudara mengalami kecelakaan? Jika ya, sertakan kecelakaan apa dan pada tahun berapa.</p>
						<div class="group-text">	
							<input name="other_pertanyaan_g" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_g');?>"/>
						</div>
						
						<p>Apakah saudara memakai kacamata? Jika ya, Min/Plus?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_h" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_h');?>"/>
						</div>
						
						<p>Apakah saudara merokok? Jika ya, sejak kapan?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_i" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_i');?>"/>
						</div>
					</div>
					...
					<div style="float:left;width:100%;">
						...
						<div class="group-text">	
							<input name="other_pertanyaan_j" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_j');?>"/>
						</div>	
						<p>Darimana saudara mengetahui adanya lowongan ini?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_k" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_k');?>"/>
						</div>
						...
						<div class="group-text">	
							<input name="other_pertanyaan_l" type="text" class="input-text" style="width:100%;" value="<?php echo set_value('other_pertanyaan_l');?>"/>
						</div>
						
						<p>Alasan / Tujuan saudara melamar di PT Gloria Origita Cosmetics?</p>
						<div class="group-text">	
							<textarea name="other_pertanyaan_m"  class="input-text" style="width:100%;"><?php echo set_value('other_pertanyaan_m');?></textarea>
						</div>
						
						<p>Apakah saudara bersedia tugas di luar jam kerja & tugas di luar kota?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_n" value="<?php echo set_value('other_pertanyaan_n');?>" type="text" class="input-text" style="width:100%;"/>
						</div>
						
						<p>Apakah saudara bersedia ditempatkan di luar kota? Jika tidak, sertakan alasannya.</p>
						<div class="group-text">	
							<textarea name="other_pertanyaan_o" value="<?php echo set_value('other_pertanyaan_o');?>" class="input-text" style="width:100%;"></textarea>
						</div>
						
						<p>Gaji yang saudara harapkan?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_p" value="<?php echo set_value('other_pertanyaan_p');?>" type="text" class="input-text" style="width:100%;"/>
						</div>
						
						<p>Jika saudara diterima di PT Gloria Origita Cosmetics, Kapan saudara siap untuk bekerja?</p>
						<div class="group-text">	
							<input name="other_pertanyaan_q" value="<?php echo set_value('other_pertanyaan_q');?>" type="text" class="input-text" style="width:100%;"/>
						</div>
						<div class="group-text">	
							<input name="agree" id="agree" type="checkbox" class="input-text" style="width:100%;" onClick="validationAgreement('agree', 'submit');"/> Dengan ini saya telah memberikan informasi dengan sebenarnya.
						</div>
					</div>
						<button type="submit" id="submit" style="padding:20px 15px;color: #fff;background-color: #8dc43f; opacity:0.7;border: 1px solid #8dc43f;cursor: pointer;float:right;" disabled>Send<i class="fa fa-send" style="margin-left:10px;"></i></button>
