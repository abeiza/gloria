			...
			<div class="row">
				<div style="margin:2%;width:98%;float:left;">
					<div style="float:left;width:100%;">
						...
						<div style="text-align:center;width:20%;float:left;">
							<i class="fa fa-mortar-board" style="padding:20px 18px;background:#fff;color:#ccc;border-radius:50%;border:2px solid #8dc43f"></i>
							<h3 style="margin-bottom:0px;margin-top:5px;">Education Info</h3>
							<span>Step 3</span>
						</div>
						<div style="text-align:center;width:20%;float:left;">
							<i class="fa fa-briefcase" style="padding:20px 21px;background:#ccc;color:#fff;border-radius:50%;"></i>
